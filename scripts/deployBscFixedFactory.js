...
async function main() {
  console.log("Deploying BSC-specific fixed TokenFactory_v3...");
  ...
  console.log("BSC Fixed TokenFactory_v3 deployed to:", tokenFactoryAddress);
  console.log("This version has special fixes for BSC wallet allocation issues");
  console.log("1. Forces direct distribution of non-vested tokens");
  console.log("2. Adds balance verification to ensure token transfer success");
  console.log("3. Zeroes out vesting parameters for non-vested wallets");
