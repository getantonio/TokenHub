...
async function main() {
  ...
  console.log("Deploying improved V4FactoryWithLiquidity (v2) with account:", deployer.address);
  ...
  // Deploy V4FactoryWithLiquidity with the improved implementation
  console.log("Deploying improved V4FactoryWithLiquidity (v2)...");
  ...
  console.log("V4FactoryWithLiquidity (v2) deployed to:", factoryAddress);
  ...
  console.log(`NEXT_PUBLIC_POLYGONAMOY_FACTORY_ADDRESS_V4_WITH_LIQUIDITY_FIXED_V2=${factoryAddress}`);
}
