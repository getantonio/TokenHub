// ABI for the TokenFactory_v2_DirectDEX_Fixed contract
export const FACTORY_ABI_FIXED = [
  {
    "inputs": [
      {
    ...
    "inputs": [
      {
        ...
        "internalType": "struct TokenFactory_v2_DirectDEX_Fixed.TokenCreationParams",
        "name": "params",
        "type": "tuple"
      }
    ],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct TokenFactory_v2_DirectDEX_Fixed.TokenInfo",
        "name": "",
        "type": "tuple"
      }
    ],
