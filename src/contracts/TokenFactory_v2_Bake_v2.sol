...
contract TokenFactory_v2_Bake_v2 is Ownable, ReentrancyGuard {
    ...
    function listTokenOnDEX(
        ...
        // Validate liquidity percentage (between 1% and 100%)
        if (liquidityPercentage < 1 || liquidityPercentage > 100) {
            revert InvalidLiquidityPercentage(liquidityPercentage);
        }
        ...
        // Calculate tokens needed for liquidity based on the provided percentage
