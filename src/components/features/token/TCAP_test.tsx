...
export default function TCAP_test({ tokenAddress }: TokenAdminTestProps) {
  ...
  const { 
    ...
    abi: SplitTokenABI.abi as unknown as Abi,
    functionName: 'name',
  }) as UseReadContractReturnType<typeof SplitTokenABI.abi, 'name'>;
  ...
  const { 
    ...
    abi: SplitTokenABI.abi as unknown as Abi,
    functionName: 'symbol',
  }) as UseReadContractReturnType<typeof SplitTokenABI.abi, 'symbol'>;
  ...
  }) as UseReadContractReturnType<typeof SplitTokenABI.abi, 'totalSupply'>;
  ...
  if (!address) {
    return (
      <div className="p-1 bg-gray-800 rounded-lg shadow-lg">
        <h2 className="text-xs font-medium text-text-primary">Token Management (Test)</h2>
    ...
    <div className="form-card">
      ...
      >
        <div className="flex items-center gap-1">
          <h2 className="text-sm font-medium text-text-primary">Token Creator Admin Controls (Test)</h2>
