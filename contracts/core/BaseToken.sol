...
contract BaseToken is ERC20, Pausable, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Add a vesting contract to the whitelist
    ...
    /**
     * @dev Remove a vesting contract from the whitelist
     * @param vestingContract Address of the vesting contract
     */
    ...
    function _transfer(
        ...
        // Skip transfer restrictions for vesting contracts
        if (!isVestingContract[sender] && !isVestingContract[recipient]) {
